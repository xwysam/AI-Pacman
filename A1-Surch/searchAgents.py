...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        for i in self.corners:
            if self.startingPosition == i:
                self.touchedCorners.append(self.startingPosition)
    ...
    def getStartState(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        startPoint = (self.startingPosition,self.touchedCorners)
        return startPoint
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                ...
                if nextStep in self.corners:
                    if not nextStep in visited:
                        visited.append(nextStep)
                successors.append(((nextStep,visited),action,1))
...
def cornersHeuristic(state, problem):
    ...
    untouchedCorners = []
    untouchedCorners.append(xy1)

    for i in corners:
        if i not in state[1]:
            untouchedCorners.append(i)
